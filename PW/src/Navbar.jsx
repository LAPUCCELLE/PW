    ...
    return (
        <div className="nav_container">
            ...
            <div className="section_promoBar_content">
                <span className="section_promo_text">Hasta 60% en selección mujer</span>
            ...
            <div className="navbar_content">
                <div className="left">
                    <img
                        className="logo_marca"
                        src="https://hmperu.vtexassets.com/assets/vtex.file-manager-graphql/images/d0e454f7-81d9-41e2-a306-f8f41c804a7c___d81e534ae8621b10d58c605eba2fcdf5.webp"
                ...
                <div className="right">
                    {/* Buscar */}
                    <button className="icon_button" aria-label="Buscar">
                        <svg viewBox="0 0 24 24" height="20" width="20">
                            <path fillRule="evenodd" d="M14.391 15.452a7 7 0 1 1 1.06-1.06l5.86 5.858-1.061 1.06-5.859-5.858ZM15.5 10a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0Z" />
                        </svg>
                    </button>

                    {/* Perfil */}
                    <Link to="/login" className="icon_button" aria-label="Perfil">
                        <svg viewBox="0 0 24 24" height="20" width="20">
                            <path fillRule="evenodd" d="M16.75 6.25a4.75 4.75 0 1 1-9.5 0 4.75 4.75 0 0 1 9.5 0Zm-1.5 0a3.25 3.25 0 1 1-6.5 0 3.25 3.25 0 0 1 6.5 0Z M12 12.5c-2.397 0-4.827.238-6.684.991-.935.38-1.767.907-2.367 1.64-.611.746-.949 1.665-.949 2.752V20h1.5v-2.117c0-.753.226-1.334.61-1.802.393-.48.986-.881 1.77-1.2C7.464 14.238 9.66 14 12 14c2.348 0 4.542.214 6.124.845.783.312 1.373.71 1.765 1.192.382.47.61 1.063.61 1.847L20.5 20H22v-2.116c0-1.107-.335-2.04-.947-2.793-.602-.74-1.436-1.266-2.374-1.64-1.858-.74-4.29-.951-6.679-.951Z" />
                        </svg>
                    </Link>
